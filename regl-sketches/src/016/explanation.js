...
function render (onChange) {
  ...
  const content = h('div', {class: 'content'}, [
    ...
    h('div', {class: 'section'}, [
      ...
      ' of the three-body problem, that is, three particles mutually attracted by gravitational force. All the orbits here are two-dimensional orbits adapted from the galley at ',
